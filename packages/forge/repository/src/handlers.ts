...
import tecpetBlockHandlers from "@typebot.io/tecpet-block/handlers";
import { tecpetAiBlock } from "@typebot.io/tecpet-ai-block";
import tecpetAiBlockHandlers from "@typebot.io/tecpet-ai-block/handlers";
import { tecpetGatewayBlock } from "@typebot.io/tecpet-gateway-block";
import tecpetGatewayBlockHandlers from "@typebot.io/tecpet-gateway-block/handlers";
...
export const forgedBlockHandlers = {
  ...
  [tecpetBlock.id]: tecpetBlockHandlers,
  [tecpetAiBlock.id]: tecpetAiBlockHandlers,
  [tecpetGatewayBlock.id]: tecpetGatewayBlockHandlers,
};
